...
import { Check, Home, Building, Factory, Loader2 } from "lucide-react";
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((product) => {
              ...
              return (
                <div
                  key={product.id}
                  className={`relative card-elevated overflow-hidden ${product.popular ? "ring-2 ring-accent" : ""
                    }`}
                >
                  {/* Popular Badge */}
                  {product.popular && (
                  ...
                  <div className="p-6 lg:p-8">
                    ...
                    <div className="flex items-center gap-4 mb-4">
                      <div className={`w-14 h-14 rounded-2xl flex items-center justify-center ${product.popular ? "bg-accent/20" : "bg-primary/10"
                        }`}>
                    ...
                    <ul className="space-y-3 mb-8">
                      {product.features?.map((feature, featureIndex) => (
                        <li key={featureIndex} className="flex items-center gap-3">
                          <div className={`w-5 h-5 rounded-full flex items-center justify-center ${product.popular ? "bg-accent/20" : "bg-primary/10"
                            }`}>
